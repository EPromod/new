...
// Menambahkan topik baru yang lebih menarik
      ...
      <div className="max-w-4xl mx-auto w-full p-4">
        <div className="bg-white rounded-3xl p-8 shadow-2xl border-b-8 border-purple-300">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-lg">Pilih topik kesukaanmu!</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {TOPICS.map((t) => (
              <Button 
                ...
                variant="accent" 
                size="md"
                className="py-4 text-sm md:text-lg font-bold shadow-purple-200 h-full"
              >
                {t}
              </Button>
            ))}
